...
public class constant {
    ...
    // API FOLDER URL
    static String prefix = "https://mdmataka.com/md/api/";

    // APK DOWNLOAD LINK
    static String link = "https://mdmataka.com/md/mdmataka.apk";

    // PROJECT ROOT URL
    static String project_root = "https://mdmataka.com/md/";

    // GENERATE WHATSAPP LINK FROM https://create.wa.link/ or some other website
    static String whatsapplink = "https://wa.link/amidzh";
