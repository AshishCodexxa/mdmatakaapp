        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (amount.getText().toString().isEmpty() || amount.getText().toString().equals("0"))
                {
                    ...
                    if (Integer.parseInt(totalamount.getText().toString()) < 10 || Integer.parseInt(totalamount.getText().toString()) > 10000)
                    {
                        AlertDialog.Builder builder1 = new AlertDialog.Builder(crossing.this);
                        builder1.setMessage("You can only bet between 10 INR to 10000 INR");
