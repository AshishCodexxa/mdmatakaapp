...
public class fullsangam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter2 = new ArrayAdapter<String>(fullsangam.this, R.layout.simple_list_item_1, patti);
        first.setAdapter(arrayAdapter2);

        ArrayAdapter<String> arrayAdapter3 = new ArrayAdapter<String>(fullsangam.this, R.layout.simple_list_item_1, patti);
